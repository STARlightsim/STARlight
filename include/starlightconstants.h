...
namespace StarlightConstants
{
  ...
  enum particle {UNKNOWN=0, ELECTRON=11, PION=211, MUON=13, TAUON=15, KAONCHARGE=321,KAONNEUTRAL=310, PROTON=212,A2=115,ETA=221,F2=225,ETAPRIME=331,F2PRIME=335,ETAC=441,F0=9010221,ZOVERZ03=33,RHO=113,RHOZEUS=913,OMEGA=223,PHI=333,JPSI=443,JPSI2S=444,JPSI_ee=443011,JPSI_mumu=443013,UPSILON=553,UPSILON2S=554,UPSILON3S=555};
