...
// $Rev:: 316                         $: revision of last commit
...
public:
	...
	double       maxRapidity           () const { return _maxRapidity.value();            }  ///< returns maximum absolute value of rapidity
        int          phiSwitch             () const { return _phiSwitch.value();              }  ///< returns switch to add phi in starlight+dpmjet output
        int          kstarSwitch           () const { return _kstarSwitch.value();            }  ///< returns switch to add Kstar in starlight+dpmjet output
	...
	void setMaxRapidity           (double v)  {  _maxRapidity = v;            }  ///< sets maximum absolute value of rapidity
  	void setphiSwitch             (double v)  {  _phiSwitch = v;            }  ///< sets switch for phi
    	void setkstarSwitch           (double v)  {  _kstarSwitch = v;            }  ///< sets switch for kstar
...
#define NO_VALIDITY_CHECK false
	...
	parameter<double, VALIDITY_CHECK>          _maxRapidity;             ///< maximum absolute value of rapidity
        parameter<int, VALIDITY_CHECK>             _phiSwitch;             ///< switch to add  phi in output
        parameter<int, VALIDITY_CHECK>             _kstarSwitch;             ///< switch to add  kstar in output 
